...
class UserController {
  static async getAllUsers(req, res) {
    ...
    try {
      ...
      return res
        .status(200)
        .json(ApiResponse.success("Users retrieved successfully", allUsers));
    } catch (error) {
      return res
        .status(500)
  ...
  static async getUserById(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(ApiResponse.success("User retrieved successfully", userData));
    } catch (error) {
      return res
        .status(500)
        .json(ApiResponse.error(error.message || "Internal server error"));
  ...
  static async updatePassword(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(ApiResponse.success("Password updated successfully", true));
    } catch (error) {
      return res
        .status(500)
        .json(ApiResponse.error(error.message || "Internal server error"));
  ...
  static async deleteUser(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(ApiResponse.success("User deleted successfully", true));
    } catch (error) {
      return res
        .status(500)
        .json(ApiResponse.error(error.message || "Internal server error"));
